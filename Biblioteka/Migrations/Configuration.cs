    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Biblioteka.Models.ProbaContext>
    {
        ...
        protected override void Seed(Biblioteka.Models.ProbaContext context)
        {
            ...
            Knjiga k1 = new Knjiga
            {
                ...
                dostupno_kopija = 1,
                izdanje = 1,
                opis = "Zloèin i kazna je roman ruskog pisca Fjodora Mihajlovièa Dostojevskog izdan 1866." +
                "godine u èasopisu Ruski vjesnik. Smatra se jednim od najveæih djela ruske književnosti.",
                izbrisano = false,
                idbroj = "1000"
            };
            ...
            Knjiga k2 = new Knjiga
            {
                ...
                dostupno_kopija = 1,
                izdanje = 1,
                opis = "Hiljadu i jedna noæ je zbirka dužih i kraæih prièa koje su nastale u periodu od" +
                "9. do 14. vijeka. Prièe imaju korijene iz starih civilizacija Arabije, Perzije, Indije, Egipta i Mezopotamije." +
                "Osnova cijele ove zbirke je prièa o Šeherzadi.",
                izbrisano = false,
                idbroj = "1001"
            };
            ...
            Knjiga k3 = new Knjiga
            {
                ...
                "potjeèe iz drevnih skandinavskih saga, a zapisao ju danski pjesnik i povjesnièar Saxo Gramaticus u 13. stoljeæu.",
                izbrisano = false,
                idbroj = "1002"
            };
            ...
            Knjiga k4 = new Knjiga
            {
                ...
                dostupno_kopija = 1,
                izdanje = 1,
                opis = "Derviš i smrt je najuspješniji roman bosanskohercegovaèkog pisca Meše Selimoviæa." +
                ...
                "najviše jugoslavenske nagrade, izmeðu ostalih Njegoševu, Goranovu i NIN-ovu nagradu.",
                izbrisano = false,
                idbroj = "1005"
            };
            ...
            Knjiga k5 = new Knjiga
            {
                ...
                dostupno_kopija = 1,
                izdanje = 1,
                opis = "Tvrðava je jedan od poznatijih romana bosanskohercegovaèkog pisca Meše Selimoviæa. " +
                ...
                "je spolja odreðen realnim historijskim vremenom.",
                izbrisano = false,
                idbroj = "1006"
            };
